...
$string['attendancepluginmissing'] = 'The Attendance activity plugin is not installed.';
$string['attendancehourlabel'] = 'Hour {$a}';
$string['attendancecoursemissing'] = 'Course {$a} could not be found.';
$string['attendancecourseerror'] = '{$a->course}: {$a->message}';
$string['attendancesummarycreated'] = 'Created {$a->sessions} attendance session(s) across {$a->courses} course(s).';
$string['attendancesummaryinstances'] = 'Created {$a} attendance activity instance(s).';
$string['attendancesummaryduplicates'] = 'Skipped {$a} session(s) that already existed.';
$string['attendancesummaryerrors'] = 'Some courses were skipped: {$a}';
